...
export default function AgentSwitcher() {
  ...
  return (
    <div ref={ref} className="relative">
      <button
        onClick={() => setOpen((o) => !o)}
        className="flex items-center gap-1.5 px-2 sm:px-2.5 py-1.5 rounded-lg text-[12px] sm:text-[12.5px] font-medium text-[var(--dmoop-text-secondary)] hover:text-[var(--dmoop-text-primary)] hover:bg-white hover:shadow-[var(--dmoop-shadow-sm)] transition-all"
      >
        <span
      ...
      {open && (
        <div
          className="absolute right-0 sm:right-auto sm:left-0 top-full mt-1.5 w-[260px] max-w-[calc(100vw-1.5rem)] rounded-xl overflow-hidden z-30 dmoop-scale-in"
          style={{
        ...
        >
          <div className="px-3.5 pt-3 pb-1.5 flex items-center justify-between">
            ...
            <Link
              href="/agents"
              className="flex items-center gap-1 text-[10.5px] font-semibold text-[var(--dmoop-accent)] hover:underline"
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-[10.5px] text-[var(--dmoop-text-tertiary)] flex items-center gap-1">
